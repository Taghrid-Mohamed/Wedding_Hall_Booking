...
public void enableAdminMode() {
    ...
    String hall = txtHallSearch.getText().trim();   // ناخذ اسم الصالة من التيكست
String date = txtDateSearch.getText().trim();   // ناخذ التاريخ من التيكست

// ✅ لو الاثنين فاضيين نوقف ونطلب منه يعبي بيانات
if (hall.isEmpty() && date.isEmpty()) {
    JOptionPane.showMessageDialog(
            this,
            "من فضلك دخّل اسم الصالة أو التاريخ قبل البحث.",   // رسالة للمستخدم
            "تنبيه",
            JOptionPane.WARNING_MESSAGE
    );
    return; // نوقف تنفيذ الدالة
}
    String customerName="" ;                                          
